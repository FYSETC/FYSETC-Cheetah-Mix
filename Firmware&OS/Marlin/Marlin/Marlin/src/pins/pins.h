...
#elif MB(FYSETC_CHEETAH_MIX)
  #include "stm32f4/pins_FYSETC_CHEETAH_MIX.h"  // STM32F4                                env:FYSETC_CHEETAH_V20
#elif MB(CREALITY_3D_PI)
  #include "stm32f4/pins_CREALITY_3D_PI.h"      // STM32F4                                env:CREALITY_3D_PI
